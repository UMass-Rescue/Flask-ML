...
def app():
    ...
    def server_process_text_with_schema(
    ...
    def server_process_texts_with_schema(
        inputs: TextInputs, parameters: IntParameters
    ) -> ResponseBody:
        return ResponseBody(root=process_texts(inputs["text_inputs"].texts, parameters))

    @server.route("/process_files_with_schema", get_task_schema(BATCHFILE_INPUT_SCHEMA, RANGED_FLOAT_PARAM_SCHEMA))
    def server_process_images_with_schema(
        inputs: FileInputs, parameters: FloatParameters
    ) -> ResponseBody:
        return ResponseBody(root=process_files(inputs["file_inputs"].files, parameters))
    
    @server.route("/process_directory_with_schema", get_task_schema(DIRECTORY_INPUT_SCHEMA, RANGED_INT_PARAM_SCHEMA))
    def server_process_directory_with_schema(
        inputs: DirInput, parameters: IntParameters
    ) -> ResponseBody:
        return ResponseBody(root=process_directory(inputs["dir_input"], parameters))
...
@pytest.mark.parametrize("endpoint,expected_response", [
    ("/process_text", { "inputs": { "text_input": {"text": "A sample piece of text" } }, "parameters": { "param1": "Sample value for parameter" } }),
    ("/process_file", { "inputs": { "file_input": { "path": "/Users/path/to/file" } }, "parameters": { "param1": 1.0 } }),
    ("/process_texts", { "inputs": { "text_inputs": { "texts": [{"text": "A sample piece of text 1"}, {"text": "A sample piece of text 2"}] } }, "parameters": { "param1": 1 } }),
    ("/process_files", { "inputs": { "file_inputs": { "files": [{"path": "/Users/path/to/file1"}, {"path": "/Users/path/to/file2"}] } }, "parameters": { "param1": 1.0 } }),
    ("/process_directory", { "inputs": { "dir_input": { "path": "/Users/path/to/folder" } }, "parameters": { "param1": 1 } }),
])
...
@pytest.mark.parametrize("endpoint,expected_response", [
    ("/process_text_with_schema", { "inputs": { "text_input": {"text": "A sample piece of text" } }, "parameters": { "param1": "default" } }),
    ("/process_textarea_with_schema", { "inputs": { "text_input": {"text": "A sample piece of text of text that's long. A sample piece of text of text that's long. A sample piece of text of text that's long. A sample piece of text of text that's long. A sample piece of text of text that's long. A sample piece of text of text that's long. A sample piece of text of text that's long. A sample piece of text of text that's long." } }, "parameters": { "param1": "option_1" } }),
    ("/process_file_with_schema", { "inputs": { "file_input": { "path": "/Users/path/to/file" } }, "parameters": { "param1": 0.0 } }),
    ("/process_texts_with_schema", { "inputs": { "text_inputs": { "texts": [{"text": "A sample piece of text 1"}, {"text": "A sample piece of text 2"}] } }, "parameters": { "param1": 1 } }),
    ("/process_files_with_schema", { "inputs": { "file_inputs": { "files": [{"path": "/Users/path/to/file1"}, {"path": "/Users/path/to/file2"}] } }, "parameters": { "param1": 0.0 } }),
    ("/process_directory_with_schema", { "inputs": { "dir_input": { "path": "/Users/path/to/folder" } }, "parameters": { "param1": 0 } }),
])
...
@pytest.mark.parametrize("endpoint,expected_response", [
    ("/process_text_with_schema", { "inputs": [{ "input_type": "text", "key": "text_input", "label": "Text Input", "subtitle": "" }], "parameters": [{ "key": "param1", "label": "Text Parameter", "subtitle": "", "value": { "parameter_type": "text", "default": "default" } }] }),
    ("/process_textarea_with_schema", { "inputs": [{ "input_type": "textarea", "key": "text_input", "label": "Text Area Input", "subtitle": "" }], "parameters": [{ "key": "param1", "label": "Enum Parameter", "subtitle": "", "value": { "parameter_type": "enum", "enum_vals": [{ "label": "Option 1", "key": "option_1" }, { "label": "Option 2", "key": "option_2" }], "message_when_empty": None, "default": "option_1" } }] }),
    ("/process_file_with_schema", { "inputs": [{ "input_type": "file", "key": "file_input", "label": "File Input", "subtitle": "" }], "parameters": [{ "key": "param1", "label": "Float Parameter", "subtitle": "", "value": { "parameter_type": "float", "default": 0.0 } }] }),
    ("/process_texts_with_schema", { "inputs": [{ "input_type": "batchtext", "key": "text_inputs", "label": "Batch Text Inputs", "subtitle": "" }], "parameters": [{ "key": "param1", "label": "Int Parameter", "subtitle": "", "value": { "parameter_type": "int", "default": 1 } }] }),
    ("/process_files_with_schema", { "inputs": [{ "input_type": "batchfile", "key": "file_inputs", "label": "Batch File Inputs", "subtitle": "" }], "parameters": [{ "key": "param1", "label": "Ranged Float Parameter", "subtitle": "", "value": { "parameter_type": "ranged_float", "default": 0.0, "range": { "min": 0.0, "max": 1.0 } } }] }),
    ("/process_directory_with_schema", { "inputs": [{ "input_type": "directory", "key": "dir_input", "label": "Directory Input", "subtitle": "" }], "parameters": [{ "key": "param1", "label": "Ranged Int Parameter", "subtitle": "", "value": { "parameter_type": "ranged_int", "default": 0, "range": { "min": 0, "max": 10 } } }] }),
])
...
@pytest.mark.parametrize("endpoint,data,expected_response", [
    ("/process_text_with_schema", {"inputs": {"text_input": {"text": "Sample text"}}, "parameters": {"param1": "default"}}, {"output_type": "text", "value": "processed_text.txt", "title": "Sample text", "subtitle": None}),
    ("/process_textarea_with_schema", {"inputs": {"text_input": {"text": "Sample text"}}, "parameters": {"param1": "option_1"}}, {"output_type": "text", "value": "processed_text.txt", "title": "Sample text", "subtitle": None}),
    ("/process_file_with_schema", {"inputs": {"file_input": {"path": "/path/to/image.jpg"}}, "parameters": {"param1": 0.0}}, {"output_type": "file", "file_type": "img", "path": "processed_image.img", "title": "/path/to/image.jpg", "subtitle": None}),
    ("/process_texts_with_schema", {"inputs": {"text_inputs": {"texts": [{"text": "Sample text"}]}}, "parameters": {"param1": 0}}, {"output_type": "batchtext", "texts": [{"output_type": "text", "value": "processed_text.txt", "title": "Sample text", "subtitle": None}]}),
    ("/process_files_with_schema", {"inputs": {"file_inputs": {"files": [{"path": "/path/to/image.jpg"}]}}, "parameters": {"param1": 0.0}}, {"output_type": "batchfile", "files": [{"output_type": "file", "file_type": "img", "path": "processed_image.img", "title": "/path/to/image.jpg", "subtitle": None}]}),
    ("/process_directory_with_schema", {"inputs": {"dir_input": {"path": "/path/to/directory"}}, "parameters": {"param1": 0}}, {"output_type": "directory", "path": "processed_images", "title": "/path/to/directory", "subtitle": ""}),
])
